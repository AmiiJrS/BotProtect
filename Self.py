...
cl.login(token="EnwapS5u4nykzZcuJXDd.sxq0nVgiPHEMkWPJgsgqxq.njJQx8nq1cprPoMs7nsgSjQ0U0BRfvtoX7ZQpCV+cRo=")
cl.loginResult()
...
admin=["u49743436f188a617a62b0a631921905d","u49743436f188a617a62b0a631921905d","u49ee1a4b1e9d683d021c5ebc4a6b5ae3","u047f201143057636144ede92e6e5ced6","u36027bbc6fd02c84881308cd3309881c","u4d81c9ad1750bcc4660ae73f6e2342fc","ua567c12c371a795cc0b2c7b8e2f57df0","ucf2b74a2de9f5f5f45aa85f9329fb10b","ua13eff7b3ba881e5eb0583420d43a422","u047f201143057636144ede92e6e5ced6","uca785625ab07a671ddd7034925a7a95c","u9020a370942cbf367081bd8da505a8ca"]
creator=["u49ee1a4b1e9d683d021c5ebc4a6b5ae3","u047f201143057636144ede92e6e5ced6","u36027bbc6fd02c84881308cd3309881c","u4d81c9ad1750bcc4660ae73f6e2342fc","ua567c12c371a795cc0b2c7b8e2f57df0","ucf2b74a2de9f5f5f45aa85f9329fb10b","ua13eff7b3ba881e5eb0583420d43a422","u047f201143057636144ede92e6e5ced6","uca785625ab07a671ddd7034925a7a95c","u9020a370942cbf367081bd8da505a8ca"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Owner : line://ti/p/~manikgajah\n\n<=<[OpenJasaBot]>=>\n\n> SelfBotProtect\n>BotProtect 5 bot\n\nSelf Dan Bot DiPisah\n#KaloMinatAddAja!!\nhttps://line.me/R/ti/p/%40manikgajah""",
    "lang":"JP",
    "comment":"""Owner : line://ti/p/~manikgajah\n\n<=<[OpenJasaSelfBot]>=>\n\n> SelfBotProtect\n> BotProtect\n#KaloMinatAddAja\nhttps://line.me/R/ti/p/%40manikgajah""",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                              ...
                              if jml > 300 and jml < 400:
                                 ...
                                 mention(msg.to, nm4)
                              cnt = Message()
                              cnt.text = "Cek Brekele : "+str(jml)
                              cnt.to = msg.to
                              cl.sendText(msg.to,"Semua Brekele Sudah Di Cek Bos😎😎")
                              cl.sendMessage(cnt)
#-----------------------------------------------
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u49ee1a4b1e9d683d021c5ebc4a6b5ae3"}
